...
pub struct TestRackDbBuilder {
    ...
    rack_id: RackId,
    rack_capabilities: Option<model::rack_type::RackCapabilitiesSet>,
}
...
impl TestRackDbBuilder {
    ...
    pub fn with_rack_capabilities(
        mut self,
        rack_capabilities: model::rack_type::RackCapabilitiesSet,
    ) -> Self {
        self.rack_capabilities = Some(rack_capabilities);
        self
    }
    ...
    pub async fn persist(&self, txn: &mut PgConnection) -> Result<RackId, DatabaseError> {
        ...
        let cfg = RackConfig {
            ...
            rack_capabilities: self.rack_capabilities.clone(),
        };
