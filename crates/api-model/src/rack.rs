...
pub struct RackConfig {
    ...
    /// rack_capabilities is the full rack capabilities set embedded at
    /// the time the expected rack is created or updated. This avoids
    /// runtime lookups against the config file and ensures the rack
    /// retains its capabilities even if the config changes later.
    #[serde(default)]
    pub rack_capabilities: Option<crate::rack_type::RackCapabilitiesSet>,
}
